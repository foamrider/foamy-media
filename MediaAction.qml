...
Rectangle {
  ...
  Row {
    ...
    MediaIcon { visible: root.iconName !== ""; width: root.iconSize; height: width; color: root.foreground; name: root.iconName; anchors.verticalCenter: parent.verticalCenter }
